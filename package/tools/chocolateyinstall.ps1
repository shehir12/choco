...
$url64      = 'https://console.amp.cisco.com/install_packages/9d83892f-cbe3-4aba-bba9-e9f531e42de6/download?product=WindowsProduct' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
